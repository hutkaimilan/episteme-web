...
- AI recepciós (későbbi fázis): szerver-oldali /app/api/chat/route.ts, az ANTHROPIC_API_KEY env változóból, modell claude-sonnet-5, max_tokens: 1000. SOHA nincs API-kulcs a kliensen.
